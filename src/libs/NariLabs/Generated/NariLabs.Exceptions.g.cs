...
namespace NariLabs
{
    ...
    public partial class ApiException : global::System.Exception
    {
        ...
        public static global::NariLabs.ApiException Create(
            ...
            global::System.Collections.Generic.IDictionary<string, global::System.Collections.Generic.IEnumerable<string>>? responseHeaders = null)
        {
            ...
            {
                case 401: return new global::NariLabs.AuthenticationException(message, innerException);
                case 402: return new global::NariLabs.PaymentRequiredException(message, innerException);
                case 403: return new global::NariLabs.AuthorizationException(message, innerException);
                case 404: return new global::NariLabs.NotFoundException(message, innerException);
                case 408: return new global::NariLabs.RequestTimeoutException(message, innerException);
                case 409: return new global::NariLabs.ConflictException(message, innerException);
                case 422: return new global::NariLabs.ValidationException(message, innerException);
                case 429:
                {
                    var retryAfter = global::NariLabs.ApiException.TryParseRetryAfter(responseHeaders);
                    return new global::NariLabs.RateLimitException(message, innerException) { RetryAfter = retryAfter };
                }
            }

            if ((int)statusCode >= 500 && (int)statusCode <= 599)
            {
                return new global::NariLabs.ServerException(message, innerException, statusCode);
            }

            return new global::NariLabs.ApiException(message, innerException, statusCode);
        }
        ...
        {
            var exception = global::NariLabs.ApiException.Create(statusCode, message, innerException, responseHeaders);
    ...
    public partial class ApiException<T> : ApiException
    {
        ...
        /// <param name="innerException">An inner exception, when one is available.</param>
        /// <param name="responseHeaders">The response headers; consulted for 429 <c>Retry-After</c> parsing when present.</param>
        public static new global::NariLabs.ApiException<T> Create(
            global::System.Net.HttpStatusCode statusCode,
            string message,
            global::System.Exception? innerException = null,
            global::System.Collections.Generic.IDictionary<string, global::System.Collections.Generic.IEnumerable<string>>? responseHeaders = null)
        {
            switch ((int)statusCode)
            {
                case 401: return new global::NariLabs.AuthenticationException<T>(message, innerException);
                case 402: return new global::NariLabs.PaymentRequiredException<T>(message, innerException);
                case 403: return new global::NariLabs.AuthorizationException<T>(message, innerException);
                case 404: return new global::NariLabs.NotFoundException<T>(message, innerException);
                case 408: return new global::NariLabs.RequestTimeoutException<T>(message, innerException);
                case 409: return new global::NariLabs.ConflictException<T>(message, innerException);
                case 422: return new global::NariLabs.ValidationException<T>(message, innerException);
                case 429:
                {
                    var retryAfter = global::NariLabs.ApiException.TryParseRetryAfter(responseHeaders);
                    return new global::NariLabs.RateLimitException<T>(message, innerException) { RetryAfter = retryAfter };
                }
            }

            if ((int)statusCode >= 500 && (int)statusCode <= 599)
            {
                return new global::NariLabs.ServerException<T>(message, innerException, statusCode);
            }

            return new global::NariLabs.ApiException<T>(message, innerException, statusCode);
        }

        /// <summary>
        /// Convenience overload that constructs an <see cref="ApiException{T}"/> with response body, object, and headers populated.
        /// </summary>
        public static global::NariLabs.ApiException<T> Create(
            global::System.Net.HttpStatusCode statusCode,
            string message,
            global::System.Exception? innerException,
            string? responseBody,
            ...
            global::System.Collections.Generic.Dictionary<string, global::System.Collections.Generic.IEnumerable<string>>? responseHeaders)
        {
            var exception = global::NariLabs.ApiException<T>.Create(statusCode, message, innerException, responseHeaders);
            exception.ResponseBody = responseBody;
    ...
    [global::System.Serializable]
    public partial class AuthenticationException : global::NariLabs.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class AuthenticationException<T> : global::NariLabs.ApiException<T>
    {
        /// <inheritdoc />
        public AuthenticationException() : base("Authentication failed.", global::System.Net.HttpStatusCode.Unauthorized) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class PaymentRequiredException : global::NariLabs.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class PaymentRequiredException<T> : global::NariLabs.ApiException<T>
    {
        /// <inheritdoc />
        public PaymentRequiredException() : base("Payment required.", global::System.Net.HttpStatusCode.PaymentRequired) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class AuthorizationException : global::NariLabs.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class AuthorizationException<T> : global::NariLabs.ApiException<T>
    {
        /// <inheritdoc />
        public AuthorizationException() : base("Authorization failed.", global::System.Net.HttpStatusCode.Forbidden) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class NotFoundException : global::NariLabs.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class NotFoundException<T> : global::NariLabs.ApiException<T>
    {
        /// <inheritdoc />
        public NotFoundException() : base("Resource not found.", global::System.Net.HttpStatusCode.NotFound) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class RequestTimeoutException : global::NariLabs.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class RequestTimeoutException<T> : global::NariLabs.ApiException<T>
    {
        /// <inheritdoc />
        public RequestTimeoutException() : base("Request timed out.", global::System.Net.HttpStatusCode.RequestTimeout) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class ConflictException : global::NariLabs.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class ConflictException<T> : global::NariLabs.ApiException<T>
    {
        /// <inheritdoc />
        public ConflictException() : base("Conflict.", global::System.Net.HttpStatusCode.Conflict) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class ValidationException : global::NariLabs.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class ValidationException<T> : global::NariLabs.ApiException<T>
    {
        /// <inheritdoc />
        public ValidationException() : base("Validation failed.", (global::System.Net.HttpStatusCode)422) { }
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class RateLimitException : global::NariLabs.ApiException
    {
    ...
    [global::System.Serializable]
    public partial class RateLimitException<T> : global::NariLabs.ApiException<T>
    {
        /// <summary>The parsed <c>Retry-After</c> delay, if present on the response.</summary>
        public global::System.TimeSpan? RetryAfter { get; set; }
    ...
    [global::System.Serializable]
    public partial class ServerException : global::NariLabs.ApiException
    {
        /// <inheritdoc />
    ...
    [global::System.Serializable]
    public partial class ServerException<T> : global::NariLabs.ApiException<T>
    {
        /// <inheritdoc />
        public ServerException() : base("Server error.", global::System.Net.HttpStatusCode.InternalServerError) { }
        /// <inheritdoc />
