...
namespace NariLabs.Realtime
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::NariLabs.Realtime.AutoSDKRetryOptions Retry { get; set; } = new global::NariLabs.Realtime.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::NariLabs.Realtime.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::NariLabs.Realtime.IAutoSDKHook>();
        ...
        public global::NariLabs.Realtime.AutoSDKClientOptions AddHook(
            global::NariLabs.Realtime.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::NariLabs.Realtime.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::NariLabs.Realtime.AutoSDKClientOptions UseAuthorizationProvider(
            global::NariLabs.Realtime.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::NariLabs.Realtime.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::NariLabs.Realtime.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::NariLabs.Realtime.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::NariLabs.Realtime.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::NariLabs.Realtime.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::NariLabs.Realtime.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::NariLabs.Realtime.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::NariLabs.Realtime.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::NariLabs.Realtime.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::NariLabs.Realtime.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::NariLabs.Realtime.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::NariLabs.Realtime.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::NariLabs.Realtime.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::NariLabs.Realtime.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::NariLabs.Realtime.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::NariLabs.Realtime.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::NariLabs.Realtime.AutoSDKClientOptions clientOptions,
            global::NariLabs.Realtime.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::NariLabs.Realtime.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::NariLabs.Realtime.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::NariLabs.Realtime.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::NariLabs.Realtime.AutoSDKClientOptions clientOptions,
            global::System.Func<global::NariLabs.Realtime.IAutoSDKHook, global::NariLabs.Realtime.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::NariLabs.Realtime.AutoSDKHookContext context)
        {
