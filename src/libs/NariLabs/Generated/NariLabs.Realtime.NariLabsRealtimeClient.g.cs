...
{
    /// <summary>
    /// Stream 16 kHz PCM16 mono audio as base64 JSON events over an authenticated WebSocket.<br/>
    /// ## Event flow<br/>
    /// 1. Send `session.configure` immediately after connecting, then wait for `session.configured`.<br/>
    /// 2. Send `input_audio_buffer.append` events while receiving optional `transcript.partial` results.<br/>
    /// 3. Send `input_audio_buffer.commit`. Receive `input_audio_buffer.committed`, then `transcript.completed` for that utterance.<br/>
    /// VAD and automatic duration boundaries can also commit an utterance. An empty manual commit returns `input_audio_buffer.commit_empty`. The connection stays open for subsequent utterances.<br/>
    /// The audio example contains one 20 ms PCM16 chunk. Append all chunks before committing an utterance. Transcript examples illustrate the event format.
    /// </summary>
    public sealed partial class NariLabsRealtimeClient : global::System.IDisposable, global::System.IAsyncDisposable
    {
        /// <summary>
        /// Default WebSocket base URL.
        /// </summary>
        public const string DefaultBaseUrl = "wss://api.narilabs.com/v1/realtime?intent=transcription";
        ...
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::NariLabs.Realtime.ServerEvent>>? MessageReceived;
        /// <summary>
        /// Raised after a SessionUpdatedMessage message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::NariLabs.Realtime.RealtimeSessionUpdatedMessage>>? SessionUpdatedMessageReceived;
        /// <summary>
        /// Raised after a PartialTranscriptMessage message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::NariLabs.Realtime.RealtimePartialTranscriptMessage>>? PartialTranscriptMessageReceived;
        /// <summary>
        /// Raised after a CompletedTranscriptMessage message is deserialized.
        /// </summary>
        ...
        /// <summary>
        /// Raised after a SpeechStartedMessage message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::NariLabs.Realtime.RealtimeSpeechStartedMessage>>? SpeechStartedMessageReceived;
        /// <summary>
        /// Raised after a SpeechStoppedMessage message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::NariLabs.Realtime.RealtimeSpeechStoppedMessage>>? SpeechStoppedMessageReceived;
        /// <summary>
        /// Raised after a ErrorEventMessage message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::NariLabs.Realtime.RealtimeErrorEventMessage>>? ErrorEventMessageReceived;
        /// <summary>
        /// Raised after a CommitEmptyMessage message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::NariLabs.Realtime.RealtimeCommitEmptyMessage>>? CommitEmptyMessageReceived;

        /// <summary>
        ///
        /// </summary>

        public global::System.Text.Json.Serialization.JsonSerializerContext JsonSerializerContext { get; set; } = global::NariLabs.Realtime.RealtimeSourceGenerationContext.Default;
        ...
        /// <summary>
        /// Creates a new instance of the NariLabsRealtimeClient.
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            {
                var __pathBuilder = new global::NariLabs.Realtime.PathBuilder(
                    path: DefaultBaseUrl);
