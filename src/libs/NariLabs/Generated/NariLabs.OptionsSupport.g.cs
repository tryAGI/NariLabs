...
namespace NariLabs
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::NariLabs.AutoSDKRetryOptions Retry { get; set; } = new global::NariLabs.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::NariLabs.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::NariLabs.IAutoSDKHook>();
        ...
        public global::NariLabs.AutoSDKClientOptions AddHook(
            global::NariLabs.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::NariLabs.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::NariLabs.AutoSDKClientOptions UseAuthorizationProvider(
            global::NariLabs.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::NariLabs.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::NariLabs.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::NariLabs.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::NariLabs.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::NariLabs.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::NariLabs.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::NariLabs.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::NariLabs.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::NariLabs.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::NariLabs.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::NariLabs.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::NariLabs.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::NariLabs.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::NariLabs.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::NariLabs.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::NariLabs.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::NariLabs.AutoSDKClientOptions clientOptions,
            global::NariLabs.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::NariLabs.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::NariLabs.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::NariLabs.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::NariLabs.AutoSDKClientOptions clientOptions,
            global::System.Func<global::NariLabs.IAutoSDKHook, global::NariLabs.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::NariLabs.AutoSDKHookContext context)
        {
